...
let styles = {
	base: [
		// Base
		'relative isolate inline-flex items-center justify-center rounded-md border text-base/6 ',
	...
	solid: [
		...
		'before:absolute before:inset-0 before:-z-10 before:rounded-[calc(theme(borderRadius.md)-1px)] before:bg-[--btn-bg]',
	...
	plain: [
		// Base
		'border-transparent text-gray-950 data-[active]:bg-gray-950/5 data-[active]:bg-gray-950/5',

		// Dark mode
		'data-[hover]:bg-gray-950/5 dark:text-white dark:data-[active]:bg-white/10 dark:data-[active]:bg-white/10 dark:data-[hover]:bg-white/10',

		// Icon
		'[--btn-icon:theme(colors.gray.500)] data-[active]:[--btn-icon:theme(colors.gray.700)] data-[active]:[--btn-icon:theme(colors.gray.700)] data-[hover]:[--btn-icon:theme(colors.gray.700)] dark:[--btn-icon:theme(colors.gray.500)] dark:data-[active]:[--btn-icon:theme(colors.gray.400)] dark:data-[active]:[--btn-icon:theme(colors.gray.400)] dark:data-[hover]:[--btn-icon:theme(colors.gray.400)]',
	],
	colors: {
		'dark/gray': [
		...
		'dark/white': [
			'text-white [--btn-bg:theme(colors.gray.900)] [--btn-border:theme(colors.gray.950/90%)] [--btn-hover-overlay:theme(colors.white/10%)]',
			'dark:text-gray-950 dark:[--btn-bg:white] dark:[--btn-hover-overlay:theme(colors.gray.950/2.5%)] dark:[--btn-hover-overlay:theme(colors.gray.950/5%)]',
	...
	size: {
		xs: 'px-[0.375rem] py-[0.125rem] sm:text-sm/4 gap-1',
		sm: 'px-1 py-[0.25rem] sm:text-sm/4 gap-1',
		md: 'px-3 py-1 sm:text-sm/6 gap-2',
	},
}
